...
export const resultPromiseFromResultAsync = <TSuccess, TFailure>(promise: Promise<Result<TSuccess, TFailure>>) : ResultPromise<TSuccess, TFailure> => ({
	...
	bindOnFailure: (bind) => resultPromiseFromResultAsync(promise.then(result => result.bindOnFailure(bind))),
	bindOnFailureAsync: (bind) => resultPromiseFromResultAsync(promise.then(result => result.bindOnFailureAsync(bind))),
